...
router.get("/:id", (req, res) => {
  ...
  res.json({
    ...
    shipping: {
      ...
      serviceCode: o.shipping?.serviceCode,
      county: o.shipping?.address?.county,
      region: o.shipping?.address?.region,
      branch: o.shipping?.address?.branch,
      store: o.shipping?.address?.store,
    },
